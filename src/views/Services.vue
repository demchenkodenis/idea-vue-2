...
<div>
    <div class="container">
        ...
        <div class="w-full flex mb-50 md:mb-70 md:justify-center">
            <button class="text-14 font-Raleway-Regular text-black-100 tracking-wide py-15 px-20 border border-black-10 magic-hover magic-hover__square hover:border-black-100" @click="scrollToFooter()">Давайте попробуем</button>
        </div>
    </div>
    ...
    <div class="container mb-100">
        ...
        <div class="grid md:grid-cols-2 md:items-center">
            <div
                ...
                "
                :class="{
                    'md:mr-40 lg:mr-50 xl:mr-70 2xl:mr-90': i == 0,
                    '2xl:ml-0': i == 1,
                    '2xl:w-full': i == 2,
                    'md:ml-40 lg:ml-50 xl:ml-70 2xl:ml-90': i == 3,
                }"
            >
        ...
        <div class="faq xl:flex">
                <div class="xl:w-1/2 xl:mr-70">
                    <h2 class="mb-30 text-20 font-Oswald tracking-wide uppercase md:text-36 lg:max-w-480 xl:text-40">{{ pageData.heading_faq }}</h2>
                </div>
                <div class="xl:w-1/2">
...
export default {
    ...
    methods: {
        getService: function () {
            ...
            axios.get('../api/getService.php?id=' + self.id)
            .then((res) => {
